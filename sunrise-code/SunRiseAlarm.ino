...
//  rtc.setTime(23, 57, 0);     // Set the time to 12:00:00 (24hr format)
...
lcd.setCursor(3,0);
  String firstHalf = getValue(input, ':', 0);
  String secondHalf = getValue(input, ':', 1);
  //int cfh = stringToNumber(firstHalf);
  //int csh = stringToNumber(secondHalf);
